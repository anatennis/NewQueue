import UniqueQueue.UniqueEventsQueue;
...
public class UEQTest {
    private final UniqueEventsQueue<Integer> queue = new UniqueEventsQueue<Integer>();
    ...
    @Test
    void testAdd() {
        UniqueEventsQueue<Integer> resultQueue = new UniqueEventsQueue<Integer>();
        resultQueue.add(156);
